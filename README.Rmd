...
paper.  This package therefore also only contains samples from the  a prospective
population-based series of 3,273 BCs.

* The count data are stores in several tables due to github file size
restrictions:
    - 


In this package data from 
