...
#'
#' @format GSE96058_sampDesc is a data frame with 3409 rows and 36 variables:
#' \describe{
...
#'
#' GSE96058_geneExpression_repl1 - a matrix of gene expression for replicated samples - replicate 1
...
#'
#' GSE96058_geneExpression_sub1 - a matrix of gene expression for random subset  of samples balanced according to pam50 category
#'    rows are feature; columns are samples.
"GSE96058_geneExpression_sub1"

#' A matrix of gene expression for a random subset  of samples balanced according to pam50 category
#'
#' GSE96058_geneExpression_sub2 - a matrix of gene expression for random subset  of samples balanced according to pam50 category
#'    rows are feature; columns are samples.
"GSE96058_geneExpression_sub2"

#' A matrix of gene expression for a random subset  of samples balanced according to pam50 category
#'
#' GSE96058_geneExpression_sub3 - a matrix of gene expression for random subset  of samples balanced according to pam50 category
#'    rows are feature; columns are samples.
"GSE96058_geneExpression_sub3"

#' A matrix of gene expression for a random subset  of samples balanced according to pam50 category
#'
#' GSE96058_geneExpression_sub4 - a matrix of gene expression for random subset  of samples balanced according to pam50 category
#'    rows are feature; columns are samples.
"GSE96058_geneExpression_sub4"

#' A matrix of gene expression for a random subset  of samples balanced according to pam50 category
#'
#' GSE96058_geneExpression_sub5 - a matrix of gene expression for random subset  of samples balanced according to pam50 category
#'    rows are feature; columns are samples.
...
#'
#' @format GSE96058_genes_annot is a data frame with 30865 rows and 8 variables:
#' \describe{
